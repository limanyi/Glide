 ...
 */
public class HorizontalGalleryFragment extends Fragment implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		getLoaderManager().initLoader(R.id.loader_id_media_store_data, null,
				this);
	}
	...
	public void onLoadFinished(Loader<List<MediaStoreData>> loader,
		...
		RecyclerAdapter adapter = new RecyclerAdapter(getActivity(),
				mediaStoreData, requestManager);
		RecyclerViewPreloader<MediaStoreData> preloader = new RecyclerViewPreloader<>(
				requestManager, adapter, adapter, 3);
		recyclerView.setOnScrollListener(preloader);

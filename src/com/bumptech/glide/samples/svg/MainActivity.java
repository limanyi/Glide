...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activitysvg_main);
		...
		requestBuilder = Glide
				...
				.apply(placeholderOf(R.drawable.image_loading).error(
						R.drawable.image_error)).transition(withCrossFade())
	...
	public void cycleScaleType(View v) {
		Log.e("cycleScaleType", "cycleScaleType");
	...
	private void reload() {
		Log.w(TAG, "reloading");
		((TextView) findViewById(R.id.button)).setText(getString(
				R.string.scaleType, imageViewRes.getScaleType()));
		loadRes();
		loadNet();
	}

	private void loadRes() {
		Log.e("loadRes", "loadRes");
	...
	private void loadNet() {
		Log.e("loadNet", "loadNet");
		Uri uri = Uri
				.parse("http://www.clker.com/cliparts/u/Z/2/b/a/6/android-toy-h.svg");

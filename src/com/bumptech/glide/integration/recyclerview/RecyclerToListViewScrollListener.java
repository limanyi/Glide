...
/**
 * Converts {@link android.support.v7.widget.RecyclerView.OnScrollListener}
 * events to {@link AbsListView} scroll events.
 * 
 * <p>
 * Requires that the the recycler view be using a {@link LinearLayoutManager}
 * subclass.
 */
public final class RecyclerToListViewScrollListener extends
	...
	public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
		...
		int visibleCount = Math.abs(firstVisible
